...
export const ExtensionId: string = 'bemberas.bember-rest-client';
...
export const ExtensionFolderName: string = '.bember-rest-client';
...
export const IncludeRegex: RegExp = /^(@@include\s+)(.+)\s*$/;
