    ...
    private async runCore(httpRequest: HttpRequest) {
        ...
        try {
            ...
            if (error.code === 'ETIMEDOUT') {
                error.message = `Please check your networking connectivity and your time out in ${this._restClientSettings.timeoutInMilliseconds}ms according to your configuration 'bember-rest-client.timeoutinmilliseconds'. Details: ${error}. `;
